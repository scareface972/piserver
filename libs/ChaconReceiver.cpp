...
static PyMethodDef ChaconReceiverMethods[] = {
	{"setCallback",  ChaconReceiver_run, METH_VARARGS, "Configure callback"},
	{"run",  ChaconReceiver_run, METH_VARARGS, "Start listen 433.92MHz Chacon message."}
};

static struct PyModuleDef ChaconReceiver_module = {
   PyModuleDef_HEAD_INIT,
   "ChaconReceiver",   /* name of module */
   NULL, 	/* module documentation, may be NULL */
   -1,      /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
   ChaconReceiverMethods
};
...
static PyObject * ChaconReceiver_run(PyObject *self, PyObject *args) {
	...
	for(;;) {
		...
		if(i>0) {
			...
			PyObject *arglist;
			arglist = Py_BuildValue("s", command.c_str());
...
static PyObject * ChaconReceiver_setCallback(PyObject *dummy, PyObject *args) {
