...
MAX_RESULT = 5
GOOGLE_SPEECH_URL = 'https://www.google.com/speech-api/v1/recognize?xjerr=1&client=chromium&pfilter=2&lang=%s&maxresults=%d' % (LANG_CODE, MAX_RESULT)
...
def search_command(rs):
    ...
    try:
        values = []
        for r in rs:
            values.append(remove_accents(r['utterance'].decode('utf-8')).lower())
        # print values
